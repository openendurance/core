...
We use an automatic code formatter called [Biome](https://biomejs.dev/). Run `pnpm format` after making any changes to the code.
...
Our code editor of choice is [VS Code](https://code.visualstudio.com/) which has [integrations with Biome](https://biomejs.dev/editors/first-party-extensions/#vs-code) and our linting tools which make this automatic. If you choose to use VS Code, these integrations will be listed as recommended extensions (or search for @recommended) in the extensions panel.
